...
public class GreetingController {
	...
	public ResponseEntity<Optional<Greeting>> getGreeting(@PathVariable("id") Long id) {

		Optional<Greeting> greeting = greetingService.findOne(id);
		if (greeting == null) {
			return new ResponseEntity<Optional<Greeting>>(HttpStatus.NOT_FOUND);
		}

		return new ResponseEntity<Optional<Greeting>>(greeting, HttpStatus.OK);
	}
